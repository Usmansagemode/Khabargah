...
class Notifications extends Component{
    ...
    onMenuOpened = () => { // this is what sends the request to backend to mark notifications as read, we have to send IDs of notifications which have to be marked read
                    ...
                    return (
                        <MenuItem key={notif.createdAt} onClick={this.handleClose}>
                            ...
                            <Typography
                                ...
                                color="initial"
                                variant="body1"
                                to={`/users/${notif.recipient}/khabar/${notif.khabarId}`}>
                                    {notif.sender} {verb} your khabar {time}
                                </Typography>
                        </MenuItem>
                    );
                })
